  ...
  render: function() {
   ...
   if (this.props.user) {
     return (
        ...
        <div className="collapsible-header grey"><a className="btn-small waves-effect waves-light"><i className="small material-icons blue-grey-text" onClick={this.handleDeleteSong}>delete</i></a>
			<a className="btn-small waves-effect waves-light"><i className="small material-icons blue-grey-text" onClick={this.handleAddSong}>playlist_add</i></a>{ songName }</div>
     	<div className="collapsible-body"><p>Artist: { artist }<br/>Album: { album }<br/>Votes: { voteCount }
			...
			<i className="small material-icons blue-grey-text" onClick={this.handleUpVote}>thumb_up</i></a>&nbsp; &nbsp;
